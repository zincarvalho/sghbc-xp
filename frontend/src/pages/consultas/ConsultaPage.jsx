                                ...
                                consultas.map((consulta) => (
                                    ...
                                    >
                                        ...
                                        <TableCell component="th" scope="row">
                                            {consulta.nomeCompleto || consulta.nome}
                                        </TableCell>
                                        <TableCell>{consulta.cpf}</TableCell>
                                        <TableCell>{formatDate(consulta.dataNascimento)}</TableCell>
                                        <TableCell>{consulta.telefone1}</TableCell>
                                        <TableCell>
                                            <IconButton
                                                aria-label="editar"
                                                color="primary"
